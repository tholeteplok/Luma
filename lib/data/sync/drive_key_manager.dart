...
class DriveKeyManager {
  ...
  Future<void> initialize(auth.AuthClient authClient) async {
    ...
    _isInitialized = true;
    print('DriveKeyManager initialized');
  }
  ...
  Future<bool> uploadKey(Uint8List key) async {
    ...
    try {
      ...
      if (existingFile != null) {
        ...
        print('Encryption key updated in Google Drive');
      } else {
        // Create new file
        ...
        print('Encryption key uploaded to Google Drive');
      }

      return true;
    } catch (e) {
      print('Error uploading encryption key: $e');
      return false;
    }
  }
  ...
  Future<Uint8List?> downloadKey() async {
    ...
    try {
      ...
      if (file == null) {
        print('No encryption key found in Google Drive');
        return null;
      }
  ...
  Future<drive.File?> _findKeyFile() async {
    try {
      ...
      print('Error finding key file: $e');
      return null;
    }
  }
  ...
  Future<bool> deleteKey() async {
    ...
    try {
      ...
      if (file != null) {
        ...
        print('Encryption key deleted from Google Drive');
        return true;
      }
