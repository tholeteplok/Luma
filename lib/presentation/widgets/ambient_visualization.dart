    ...
    return Row(
      ...
      children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: LumaColors.accentMuted.withOpacity(0.3),
          ),
        ),
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: LumaColors.accentMuted.withOpacity(0.5),
          ),
        ),
      ],
    );
    ...
    return Column(
      ...
      children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: LumaColors.accentMuted.withOpacity(0.15),
          ),
        ),
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: LumaColors.accentMuted.withOpacity(0.25),
          ),
        ),
        const SizedBox(height: 16),
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: LumaColors.accentMuted.withOpacity(0.4),
          ),
        ),
      ],
    );
